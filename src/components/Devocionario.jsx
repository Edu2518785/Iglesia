...
export default function Devocionario() {
      ...
      contenido: (
        <>
          <p>
            ...
            ha de venir a juzgar a vivos y muertos. Creo en el Espíritu Santo;
      ...
      contenido: (
        <>
          <p>
            ...
            ofendido; también me pesa porque podrías castigarme con las penas
            del infierno. Ayudado de tu divina gracia, propongo firmemente
            nunca más pecar, confesarme y cumplir la penitencia que me fuese
            impuesta. Amén.
          </p>
        </>
      ),
  ...
  return (
    <main className="devocionario-container">
      ...
      {/* Cuadros de oraciones */}
      <div className="oraciones-grid">
        {oraciones.map((o) => (
          <div
            key={o.id}
            className={`oracion-card ${
              oracionSeleccionada === o.id ? 'active' : ''
            }`}
      ...
      {oracionSeleccionada && (
        <div className="oracion-detalle">
          <h3>
            {oraciones.find((o) => o.id === oracionSeleccionada).nombre}
          </h3>
          <p>
            {oraciones
              .find((o) => o.id === oracionSeleccionada)
              .contenido}
          </p>
        </div>
      )}
